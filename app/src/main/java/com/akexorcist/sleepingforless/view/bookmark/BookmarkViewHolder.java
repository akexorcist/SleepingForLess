...
public class BookmarkViewHolder extends RecyclerView.ViewHolder {
    ...
    private void bindView(View view) {
        tvTitle = view.findViewById(R.id.tv_bookmark_title);
        tvLabel = view.findViewById(R.id.tv_bookmark_label);
        mrlFeedButton = view.findViewById(R.id.mrl_bookmark_button);
    }
